...
\begin{frame}{What is a Stochastic Control Problem?}
    ...
    \textcolor{blue}{J'aimerais bien mettre en context ces equations en parlant d'un steering motor pour un driverless vehicule et apres faire le lien avec les flow + diffusion models}
...
\begin{frame}{The Optimal Control Objective}
    ...
    %     The optimal control balances \textcolor{red}{minimizing costs} $f$ and $g$ while \textcolor{blue}{avoiding excessive control effort} $\|u\|^2$.
    % \end{alertblock}
\end{frame}
