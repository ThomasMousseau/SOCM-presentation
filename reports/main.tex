...
\begin{frame}{What is a Stochastic Control Problem?}
    ...
    \note{Je dois revoir la facon que je presente les SOC, je dois specifiquement presenter tous les
    elements des SDE ici comme le drift coefficient, le diffusion coefficient, et la fonction de coût.}
\end{frame}
